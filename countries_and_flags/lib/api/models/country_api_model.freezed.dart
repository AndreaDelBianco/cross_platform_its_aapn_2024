...
mixin _$CountryApiModel {
  CountryFlagsApi get flags => throw _privateConstructorUsedError;
  CountryNameApi get name => throw _privateConstructorUsedError;
...
abstract class $CountryApiModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({CountryFlagsApi flags, CountryNameApi name, String cca2});

  $CountryFlagsApiCopyWith<$Res> get flags;
  $CountryNameApiCopyWith<$Res> get name;
}
...
class _$CountryApiModelCopyWithImpl<$Res, $Val extends CountryApiModel>
  ...
  @pragma('vm:prefer-inline')
  $CountryFlagsApiCopyWith<$Res> get flags {
    return $CountryFlagsApiCopyWith<$Res>(_value.flags, (value) {
  ...
  @pragma('vm:prefer-inline')
  $CountryNameApiCopyWith<$Res> get name {
    return $CountryNameApiCopyWith<$Res>(_value.name, (value) {
...
class _$CountryApiModelImpl
  ...
  @override
  final CountryFlagsApi flags;
  @override
  final CountryNameApi name;
  @override
  final String cca2;
...
abstract class _CountryApiModel implements CountryApiModel {
  const factory _CountryApiModel(
      {required final CountryFlagsApi flags,
      required final CountryNameApi name,
  ...
  @override
  CountryFlagsApi get flags;
  @override
  CountryNameApi get name;
  @override
  String get cca2;
